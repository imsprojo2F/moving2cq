            ...
            <table id="dataTable" class="table display order-column" style="text-align:center;cursor:pointer;">
                <thead>
                    <tr>
                        ...
                        <th style="text-align:center;">载重量</th>
