...
public class CryptUtil {
	...
	public static byte[] ivBase64 = Base64.decodeBase64("ac80PYOAkewM6OrceBSc7g==");
	public static byte[] key128Base64 = Base64.decodeBase64("Ege8HbbmsSz0RlKR/Ynjsw==");
	...
	public static class AESKeyGen {
		...
		public static void main(String[] args) {
			System.out.println("ivBase64=Base64.decodeBase64(\"" + new String(Base64.encodeBase64(generateIV()))
					+ "\");");
			System.out.println("key128Base64=Base64.decodeBase64(\""
					+ new String(Base64.encodeBase64(generateAesKey())) + "\");");
		}
